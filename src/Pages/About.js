        ...
        <div className="grid gap-10 justify-center items-center lg:grid-cols-2">
          ...
          <div className="">
            ...
            <p className="text-base text-black lg:text-2xl text-lg flex flex-col gap-3 text-justify">
              <span>
                I am Ubongabasi Joseph, a Full Stack Software Engineer with 2 years experience, I also have have a 4 years experience in cryptocurrency trading and blockchain product management. I possess a deep understanding of technology and innovation, which allows me to drive growth.
              </span>
